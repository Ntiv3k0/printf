 ...
 * Return: Number of chars that areprinted.
 */
...
/* PRINT BACKWARDS */
/**
 * print_reverse - Prints backwards string.
 * @types: Array of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Sum active flags
 * @width: Return width
...
/* PRODUCE A STRING IN THE ROT13 */
/**
 * print_rot13string - Output a string in rot13.
 * @types: Array of arguments
 * @buffer: print to be handled by the buffer arrar
 * @flags:  Sum active flags
 * @width: Return width
 * @precision: Precision specification
 * @size: Value specifier
 * Return: Numbers of chars outputed
 */
